...
public class LineTest {
    ...
    public void testConstructor_throwsExceptionForIdenticalDots() {
        Dot dot1 = new Dot(new Ratio(1), new Ratio(2));
        Dot dot2 = new Dot(new Ratio(1), new Ratio(2));
    ...
    public void getLinear2DPolynomial() {
        ...
        Dot d1_1 = new Dot(new Ratio(1), new Ratio(1));
        Dot d2_1 = new Dot(new Ratio(2), new Ratio(3));
        ...
        Dot d1_2 = new Dot(new Ratio(1), new Ratio(3));
        Dot d2_2 = new Dot(new Ratio(2), new Ratio(3));
        ...
        Dot d1_3 = new Dot(new Ratio(3), new Ratio(1));
        Dot d2_3 = new Dot(new Ratio(3), new Ratio(2));
        ...
        Dot d1_4 = new Dot(new Ratio(1), new Ratio(1));
        Dot d2_4 = new Dot(new Ratio(3), new Ratio(3));
